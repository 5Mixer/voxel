...
HX_DECLARE_STACK_FRAME(_hx_pos_6ed07173d6a5850b_43_new)
...
class HXCPP_CLASS_ATTRIBUTES Stbtt_temp_region_obj : public ::hx::Object
{
	...
	public:
		...
		inline static ::hx::ObjectPtr< Stbtt_temp_region_obj > __new() {
			::hx::ObjectPtr< Stbtt_temp_region_obj > __this = new Stbtt_temp_region_obj();
			__this->__construct();
			return __this;
		}

		inline static ::hx::ObjectPtr< Stbtt_temp_region_obj > __alloc(::hx::Ctx *_hx_ctx) {
			Stbtt_temp_region_obj *__this = (Stbtt_temp_region_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Stbtt_temp_region_obj), false, "kha.graphics2.truetype.Stbtt_temp_region"));
			*(void **)__this = Stbtt_temp_region_obj::_hx_vtable;
{
		...
		::String __ToString() const { return HX_("Stbtt_temp_region",c1,8d,08,7f); }
