...
kha__graphics4__GeometryShader kha_graphics4_GeometryShader_fromSource(String r0) {
	hl__types__ArrayObj r2, r3;
	kha__graphics4__GeometryShader r1;
	int *r7;
	vbyte *r6, *r8;
	int r5, r9;
	r1 = (kha__graphics4__GeometryShader)hl_alloc_obj(&t$kha_graphics4_GeometryShader);
	r2 = NULL;
	r3 = NULL;
	kha_graphics4_GeometryShader_new(r1,r2,r3);
	r5 = 0;
	...
	r8 = hl_kore_geometryshader_from_source(r8);
	r1->_shader = r8;
	return r1;
}

void kha_graphics4_GeometryShader_delete(kha__graphics4__GeometryShader r0) {
	return;
}
